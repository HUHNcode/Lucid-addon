...
import  huhncode.lucid.lucidaddon.modules.utils.JinxUtils;
import huhncode.lucid.lucidaddon.modules.utils.Line;
...
public class StrongholdFinder extends Module {
    ...
    public StrongholdFinder() {
        super(LucidAddon.CATEGORY, "StrongholdFinder", "Triangulation Stronghold location ()\nThrow two eyes of ender");
    }
